...
import com.ggeit.pay.entity.RecommendDepartEntity;
...
@Service
public class RecommendDepartServiceImpl implements RecommendDepartServiceInf{
	private final static Logger logger = LoggerFactory.getLogger(RecommendDepartServiceImpl.class);
	...
	public void insert(Map<String, Object> map) {
		...
		RecommendDepartEntity dept = new RecommendDepartEntity();
	...
	public List<Map<String, Object>> findallFromDepartinfo() {
		// TODO Auto-generated method stub
		List<RecommendDepartEntity> findList = mongotemplate.findAll( RecommendDepartEntity.class,"recommended_dept");
	...
	public List<Map<String, Object>> findByOne(Map<String, Object> reqmap) {
		...
		List<RecommendDepartEntity> datalist = mongotemplate.find(query, RecommendDepartEntity.class,"recommended_dept");
	...
	public void updatebyOne(Map<String,Object> updatemap)  {
	    ...
	    mongotemplate.upsert(query, update, "recommended_dept");
	}
	...
	public void delete(Map<String, Object> deletemap) {
	    ...
	    mongotemplate.remove(query, "recommended_dept");
	}
